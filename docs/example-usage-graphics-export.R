...
hgd_plot(width = 600, height = 340, zoom = 1.4, file = "docs/example-usage-1.svg")
...
hgd_plot(width = 600, height = 340, zoom = 1.4, file = "docs/example-usage-2.svg")
...
hgd_plot(width = 600, height = 340, zoom = 1.4, file = "docs/example-usage-3.svg")
